...
const Banner = () => {
    return (
        <header className="flex flex-col-reverse sm:flex-row items-center justify-center sm:justify-between px-4 py-8 sm:px-0">
            {/* First Part */}
            <div className="sm:w-1/2 sm:ml-10 lg:ml-36 text-center sm:text-left">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-700 mb-4 sm:mb-6 lg:mb-8 leading-loose" style={{ lineHeight: '5.1rem' }}>One Step<br />Closer To Your<br /> <span className="text-purple-500">Dream Job</span></h1>
